 ...
 * Not to be confused with a run's own lease heartbeat (`RunStore.heartbeat`) — this one answers
 * "is any worker currently alive at all", for an API-only process's `/ready` and `/stats`, which
